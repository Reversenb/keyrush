...
// =========================================================================
function WpmChart({ points, avg, accentHex, isDark, isHacker, isDragon, isSakura, isSky, isMint }: {
  points: number[]; avg: number; accentHex: string; isDark: boolean; isHacker: boolean; isDragon: boolean; isSakura: boolean; isSky: boolean; isMint: boolean;
}) {
  ...
  const gridColor = isHacker ? (isDragon ? 'rgba(239,68,68,0.14)' : 'rgba(34,197,94,0.14)') : isDark ? 'rgba(255,255,255,0.10)' : isSakura ? 'rgba(190,24,93,0.14)' : isSky ? 'rgba(3,105,161,0.14)' : isMint ? 'rgba(4,120,87,0.14)' : 'rgba(154,52,18,0.14)';
  const inkMuted = isHacker ? (isDragon ? 'rgba(248,113,113,0.55)' : 'rgba(74,222,128,0.55)') : isDark ? 'rgba(255,255,255,0.5)' : isSakura ? 'rgba(157,23,77,0.6)' : isSky ? 'rgba(7,89,133,0.6)' : isMint ? 'rgba(6,95,70,0.6)' : 'rgba(124,45,18,0.6)';
  const ink = isHacker ? (isDragon ? '#fca5a5' : '#86efac') : isDark ? '#ffffff' : isSakura ? '#500724' : isSky ? '#082f49' : isMint ? '#022c22' : '#431407';
