...
// =========================================================================
function HistoryCalendar({ activityByDay, selectedDate, onSelect, isDark, isAmethyst, isHacker, isDragon, isSakura, isSky, isMint }: {
  activityByDay: Record<string, number>;
  selectedDate: string | null;
  onSelect: (key: string | null) => void;
  isDark: boolean; isAmethyst: boolean; isHacker: boolean; isDragon: boolean; isSakura: boolean; isSky: boolean; isMint: boolean;
}) {
  ...
  const accentHex = isHacker ? (isDragon ? '#ef4444' : '#22c55e') : isDark ? (isAmethyst ? '#c084fc' : '#facc15') : isSakura ? '#ec4899' : isSky ? '#0ea5e9' : isMint ? '#10b981' : '#f97316';
