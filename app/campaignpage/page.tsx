...
export default function CampaignPage() {
  ...
  const themeColorHex = isHacker ? (isDragon ? '#ef4444' : '#22c55e') : isDark ? (isLinux ? (isAmethyst ? '#c084fc' : '#facc15') : '#60a5fa') : currentTheme === 'sky' ? '#0ea5e9' : currentTheme === 'mint' ? '#10b981' : (isLinux ? '#f97316' : '#3b82f6');
